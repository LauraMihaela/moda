...
@if(auth()->user()->role_id == config('constants.roles.admin_role'))
  <div class = "btn-group">
    <button type="button" id="create-client" class="btn btn-primary btn-lg m-3">Crear nuevo cliente</button>
...
<div class="card shadow mb-4" id="mainCardShadow">
    <div class="card-header py-3">
      <h4 class="m-0 font-weight-bold text-primary text-center">Lista de usuarios de tipo cliente</h4>
    </div>
        ...
        <table class="table table-bordered changableTable" id="mainTableClients">
            <thead class="text-center">
                <tr class="text-center">
                    <th class="bg-primary">Nombre del cliente</th>
