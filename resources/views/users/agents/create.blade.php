    ...
    <div class="container">
        <div class="card bg-light">
            <article class="card-body mx-auto">
                <h4 class="card-title mt-3 text-center">@lang('messages.create-an-agent-user')</h4>
                ...
                <form method="post" action="{{ url('users/agents') }}" class="form-horizontal" enctype="multipart/form-data"> 
                    ...
                    <div class="form-group">
                        <button type="submit" id="register-submit" class="btn btn-primary btn-block">@lang('messages.create-the-agent-user')</button>
                    </div>   
                </form>
