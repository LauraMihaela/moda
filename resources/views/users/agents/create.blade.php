...
@section('content')
    ...
    <div class="container">
        <div class="card bg-light">
            <article class="card-body mx-auto">
                <h4 class="card-title mt-3 text-center">Creación de un usuario de tipo agente</h4>

                <form method="post" action="{{ url('users/agents') }}" class="form-horizontal" enctype="multipart/form-data"> 
                    @csrf
                    ...
                    <div class="form-group">
                        <button type="submit" id="register-submit" class="btn btn-primary btn-block">Crear usuario agente</button>
                    </div>   
                </form>
    ...
    @section('customScripts')
        @include('users.agents.agent-create-js')
    @endsection
