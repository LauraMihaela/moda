    ...
    <div class="container">
        <div class="card bg-light">
            <article class="card-body mx-auto">
                <h4 class="card-title mt-3 text-center">@lang('messages.editing-the-agent') {{$agent->username}}</h4>
                ...
                <form action="{{route('users.agents.update',$agent->id )}}" class="form-horizontal" enctype="multipart/form-data" method="POST"> 
                    ...
                    <div class="form-group">
                        <button type="submit" id="edit-agent-submit" class="btn btn-primary btn-block">@lang('messages.edit-the-agent-user')</button>
                    </div>    
                </form>
