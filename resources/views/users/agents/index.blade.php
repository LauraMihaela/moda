...
@if(auth()->user()->role_id == config('constants.roles.admin_role'))
  <div class = "btn-group">
    <button type="button" id="create-agent" class="btn btn-primary btn-lg m-3">Crear nuevo agente</button>
...
<div class="card shadow mb-4" id="mainCardShadow">
    <div class="card-header py-3">
      <h4 class="m-0 font-weight-bold text-primary text-center">Lista de usuarios de tipo agente</h4>
    </div>
      ...
      <table class="table table-bordered changableTable" id="mainTableAgents">
            <thead class="text-center">
                <tr class="text-center">
                    <th class="bg-primary">Nombre del usuario agente</th>
